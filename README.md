...
- Updated for Figura 0.1.5+1.21.10 (Fabric only — I kept it simple)
...
- `deps/figura-0.1.5+1.21.10-fabric-mc.jar`

### How to build the Figura jar
1. Download Figura from the `1.21.10` branch:
   - `https://github.com/FiguraMC/Figura/tree/1.21.10`
2. Build the Fabric jar from the Figura repo (git checkout "1.21.10" && ./gradlew :fabric:build).
3. Copy the built jar into this repo at:
   - `FiguraSVC-compat/deps/figura-0.1.5+1.21.10-fabric-mc.jar`
